...
- (No explicit named factions yet — the universe is one of small isolated outposts; "Earth" exists offstage and lost colonies orbit its absence.)
...
- Strugatsky × Matt Haig — observer in alien-to-them context, single unresolved moral dilemma, slow contemplative pace, occasional dry irony
- A1 grammar discipline (present indicative + *ir+a+inf* + basic perfecto/indefinido; no subjuntivo)
- Self-contained stories, no cliffhangers; the universe accumulates lore, not unresolved plot threads
...
Each block below was written by the `story` skill at story-creation time. New blocks are appended at the bottom. Top-level lists are touched up by hand from these.

### #01 — saturn-ai
- Characters: ARES (AI)
- Locations: Anillo-7 (Saturn observatory)
- Terms: cryosleep / los dormidos
- Timeline: Día 412

### #02 — nueva-andalucia
- Characters: Elena (anthropologist)
- Locations: Nueva Andalucía (lost colony)
- Terms: Saturno-Patrón (cult), el silencio
- Timeline: Año 80 del silencio

### #03 — zumbido-deriva
- Characters: Marco (navigator)
- Ships: *Tortuga* (ice tug)
- Locations: outer drift, ruta a Ceres
- Terms: zumbido (mysterious signal)

### #04 — algo-verde
- Characters: Lucía (biologist)
- Locations: Europa-3 (Jupiter system, on the ice)

### #05 — pasajero-unico
- Characters: Tomás (maintenance engineer)
- Ships: *Caracol* (generation ship)
- Timeline: Año 198 / 800 to Próxima Centauri

### #06 — la-traductora
- Characters: Inés (junior linguist)
- Locations: Instituto de Lenguas (Mars)

### #07 — el-desvio
- Characters: Mateo (cargo captain)
- Ships: *La Mula* (freighter)
- Locations: cinturón de asteroides (Mars–Ceres)

### #08 — el-ultimo-que-recuerda
- Characters: Don Joaquín (old colonist)
- Locations: Nueva Andalucía (returning, 5 yr after #2)
- Timeline: Año 85 del silencio

### #09 — la-senal
- Characters: Mariela (radioastrónoma)
- Locations: Estación Casiopea (Plutón, icy surface)

### #10 — el-reloj
- Characters: Sofía (software maintainer)
- Locations: Colonia Brasa (Kuiper Belt religious outpost)

### #11 — la-dosis
- Characters: Dra. Ana Soto (doctor)
- Locations: Estación Argyre (Mars, terraforming, ~40 colonists)
